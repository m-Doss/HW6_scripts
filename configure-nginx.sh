...
sudo curl https://raw.githubusercontent.com/malekaldoss/AzureVM/main/default | sudo tee -a /etc/nginx/sites-available/default
...
sudo git clone https://github.com/m-Doss/HW6_website.git
